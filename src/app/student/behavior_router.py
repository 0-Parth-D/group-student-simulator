...
from app.knowledge.kg_config import MASTERY_LABELS, get_construct_def, LP_PISA_TO_LEGACY
from app.knowledge.graph import get_prerequisite_gaps
from app.student.models import Student
from app.knowledge.pisa import attribute_error_templates, weak_attributes

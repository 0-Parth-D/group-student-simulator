...
from app.knowledge.kg_config import lp_pisa_to_legacy_profile
from app.student.learning_profile import derive_learning_profile
...
DEMO_STUDENTS: Dict[str, dict] = {
    ...
    "sam": {
        "name": "Sam",
        "grade": 7,
        "persona": "Anxious, easily frustrated, shuts down when confused, stronger on procedures than concepts",
        "big_five": {
            "openness": 0.4,
        ...
        "past_performance": [
            ...
            },
            {
                "task_id": "phone_plans_linear_01",
                "reply_quality": "partial",
                "observed_error": "writes correct equations and knows 0.1 is per-text rate; checks one value, does not find crossover",
                "stack_level_shown": 2,
                "student_reply": (
                    "Plan A is 20 + 0.1x because it's $20 plus 10 cents each text, "
                    "and Plan B is 0.3x. At 50 texts Plan B is cheaper... "
                    "I don't know if it stays that way for bigger numbers."
                ),
            },
            {
                "task_id": "ratio_identify_01",
    ...
    "morgan": {
        ...
        "grade": 7,
        "persona": (
            "Strong math student — careful, explains reasoning, rarely makes procedural slips "
            "on fraction and ratio work"
        ),
        "big_five": {
            "openness": 0.65,
        ...
        "past_performance": [
            ...
            },
            {
                ...
                "stack_level_shown": 3,
                "student_reply": (
                    "Plan A is 20 + 0.1x and Plan B is 0.3x. Set them equal: "
                    "20 + 0.1x = 0.3x so x = 100 texts. Plan B is cheaper before that, "
                    "Plan A after."
                ),
            },
            {

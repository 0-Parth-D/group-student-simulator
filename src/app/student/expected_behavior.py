...
from app.knowledge.construct_text import construct_label, mastery_descriptor
from app.knowledge.kg_config import MASTERY_LABELS, load_misconception_catalog

MODE_CLAUSES = {
    "WRONG": "Confident but incorrect: commit to the error instead of hedging.",

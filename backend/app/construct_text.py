...
Both the eval yardstick (`app.expected_behavior`) and semantic scaffold detection
(`app.scaffold_detector`) source their text here, so adding a scenario needs a task
...
from app.kg_config import MASTERY_LABELS, get_construct_def, list_construct_ids

...
def _persona_hint(profile_id: str) -> str:
    hints = {
        "jordan": "confident, talkative, often wrong; guesses rather than careful reasoning",
        "sam": "anxious, hedges, stronger on procedures; should not lecture",
        "alex": "quiet, brief, procedural/conceptual mix; waits to be invited",
        "morgan": "careful, explains reasoning without tutoring peers",
    }
